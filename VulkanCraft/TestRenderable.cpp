...
void VulkanCraft::TestRenderable::update() {
	...
	auto rotation = glm::rotate(glm::mat4(1.0f), (timePassed * this->rotationSpeed) * glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	auto translation = glm::translate(glm::mat4(1), this->positionOffset);
